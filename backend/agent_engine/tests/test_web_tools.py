...
@patch("agent_engine.tools.web_tools._tavily_search", return_value=[])
@patch("agent_engine.tools.web_tools._duckduckgo_search")
...
@patch("agent_engine.tools.web_tools.httpx.Client")
