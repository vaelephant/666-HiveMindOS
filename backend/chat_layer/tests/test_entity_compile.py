...
def test_compile_entity_uses_resolver(tmp_path: Path):
    ...
    with patch("chat_layer.core.compiler.chat_digest_compiler.MemoryGraph") as graph_cls:
        with patch("chat_layer.core.compiler.chat_digest_compiler.EntityResolver") as resolver_cls:
            with patch("chat_layer.core.compiler.chat_digest_compiler.upsert_entity_page", return_value="entities/Acme_Corp.md") as upsert:
                with patch("chat_layer.core.compiler.chat_digest_compiler.wiki_meta.record_entity_compile"):
                    with patch("chat_layer.core.compiler.chat_digest_compiler.wiki_meta.record_digest_compile"):
