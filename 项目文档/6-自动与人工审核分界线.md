...
| 解析阈值 | `memory_layer/knowledge_base/settings/resolver.yaml` |
| 分类词汇表 | `memory_layer/knowledge_base/settings/taxonomy.yaml` |
| Resolver 实现 | `memory_layer/knowledge_base/core/services/candidate_service.py` |
