...
- 未自定义时：使用 `knowledge_base/settings/playbook.yaml` 中的 **系统默认** 模板  
...
- **与 Hermes 等 Agent 产品同思路，但嵌入 Wiki 沉淀层与审批体系**
...
`knowledge_base/core/services/context_builder.py`
...
`knowledge_base/settings/playbook.yaml`
...
```
knowledge_base/storage/orgs/demo/playbook.md
```
