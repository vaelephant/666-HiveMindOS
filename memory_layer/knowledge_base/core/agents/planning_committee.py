"""Planning Committee — 轻量多角色规划会议（角色定义见 settings/planning_committee.yaml）。"""
...
from memory_layer.knowledge_base.core.agents.planner_agent import (
    _fallback_plan,
    validate_plan,
)
...
from memory_layer.knowledge_base.core.tools.task_toolkit import TaskToolExecutor, format_tools_for_prompt
...
# 兼容旧 import
is_chat_upgrade = lambda c: (c or {}).get("source") == "chat_upgrade"
should_use_committee = should_trigger_committee
